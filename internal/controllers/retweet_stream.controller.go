...
func RetweetStreamOne(c *gin.Context) {
	...
	var f interfaces.IFilter = &models.RetweetStreamFilter{}
	one, err := services.RetweetStream.One(c, &f, cast.ToUint(id))
	if err != nil {
		response.Error(err.Error(), http.StatusBadRequest, c)
		return
	}
...
func RetweetStreamAdd(c *gin.Context) {
	...
	var f interfaces.IFilter = &models.RetweetStreamFilter{}
	newId, err := services.RetweetStream.Add(c, &f, model)
	if err != nil {
		response.Error(err.Error(), http.StatusBadRequest, c)
		return
	}
...
func RetweetStreamUpdate(c *gin.Context) {
	...
	var f interfaces.IFilter = &models.RetweetStreamFilter{}
	updated, err := services.RetweetStream.Update(c, &f, model, cast.ToUint(id))
	if err != nil {
		response.Error(err.Error(), http.StatusBadRequest, c)
		return
	}
...
func RetweetStreamDel(c *gin.Context) {
	...
	var f interfaces.IFilter = &models.RetweetStreamFilter{}
	deleted, err := services.RetweetStream.Delete(c, &f, cast.ToUint(id))
	if err != nil {
		response.Error(err.Error(), http.StatusBadRequest, c)
		return
	}
